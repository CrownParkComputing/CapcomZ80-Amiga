#!/usr/bin/env python3
"""Build the RTG-sized 1943 bezel backdrop from The Bezel Project overlay."""
from pathlib import Path
from PIL import Image

HERE = Path(__file__).resolve().parent
SRC = HERE.parent / "assets" / "1943_bezelproject.png"
OUT_BIN = HERE / "build" / "bezel" / "c1943_bezel_864x486.bin"
