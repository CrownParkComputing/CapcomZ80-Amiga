/* src/hal/c1942_render.h -- 1942 -> Amiga 7-bitplane renderer (pure C).
 * 1942 has 256 indirect pens but only 50 unique PROM colours, so those pens are
 * remapped losslessly into 7 AGA planes. Rendered UPRIGHT (ROT270):
...
void c1942_render_prealloc(void);              /* fast-RAM decoded gfx + chunky work buffer */
